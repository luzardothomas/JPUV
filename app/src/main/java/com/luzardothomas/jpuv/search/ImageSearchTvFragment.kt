...
import com.luzardothomas.jpuv.utils.ImageCardPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSpeechRecognitionCallback {
            try {
                ...
                // Usamos el nuevo launcher en lugar de startActivityForResult
        ...
        // Le decimos al fragmento que nosotros proveemos los datos
