...
/**
 *  Gestiona el comportamiento y recuperación de los videos en el reproductor
 */
                ...
                try {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed({
                        try {
                            ...
                            Log.e("DEBUG_VLC", "El reproductor murió antes de restaurar el volumen. Servidor caído.", e)
                        }
                    }, 50)

                } catch (e: IllegalStateException) {
                    Log.e("DEBUG_VLC", "No se pudo iniciar el micro-play. Estado inválido de VLC.", e)
                }
            }
