...
/**
 *  Main de la aplicación de Mobile
 */
class MobileMainFragment : Fragment(R.layout.fragment_mobile_main) {
    ...
    private val PREFS_NAME = "jpuv_prefs"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Enlazamos el Switch normal de Android
        val switchApi = view.findViewById<android.widget.Switch>(R.id.switchApi)
        val prefs = requireContext().getSharedPreferences("app_prefs", Context.MODE_PRIVATE)

        // Pintar estado inicial sin disparar el listener
        val isApiEnabled = prefs.getBoolean("USE_API", true)
        switchApi.isChecked = isApiEnabled


        // Lógica de cambio con la animación nativa de deslizamiento
    ...
    private fun render(rootView: View) {
        ...
        rv.adapter = MobileSectionsAdapter(
            ...
            onMovieClick = { item ->
                ...
                // =========================
                // Launcher playlist RANDOM (una sola card)
                // =========================
                ...
                when (url) {
                    ...
                    "__action_web_search__" -> {
                        // Obtener los archivos y ordenarlos A-Z
                        ...
                        if (listForIntent.isEmpty()) {
                            ...
                            // Crear el Intent con los datos necesarios
                            val intent = Intent(requireContext(), ImageSearchActivity::class.java).apply {
                                putStringArrayListExtra("TARGET_JSONS", listForIntent)
                            }

                            // Lanzar con el código 100 para que onActivityResult refresque la pantalla al volver
    ...
    private fun showDeleteDialog() {
        // Obtener y ordenar la lista A-Z por nombre de archivo (Ignorando mayúsculas)
        val imported = jsonDataManager.getImportedJsons()
        ...
        // Generar los nombres "limpios" para la lista
        ...
        AlertDialog.Builder(requireContext()).apply {
            ...
            setItems(labels) { _, which ->
                ...
                // Diálogo de confirmación para Mobile
                AlertDialog.Builder(requireContext()).apply {
